...
<html>
 <head>
	...
	<title>About us:: London's Day out:: Day Trips to exciting places of London::UK</title>
...
-->
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="784" height="1108">
    <!-- MSTableType="layout" -->
    <tr>
      ...
      <td colspan="12" bgcolor="#504F4F" style="border-left: 1px solid #504F4F; border-right: 1px solid #504F4F; border-top-width: 1px; border-bottom-width: 1px"> 
        <div id="navigation" style="width: 100%; height: 29px">
			<ul>
				...
				<li id="pagein"><a href="aboutus.php" title="About">About us</a></li>
...
background-repeat: repeat-x">&nbsp;</td>
	...
	<tr>
      <td valign="top" rowspan="13" bgcolor="#F3F3F3" style="border-bottom: 1px solid #C0C0C0">
	    <Table border="0" width="337" height="632" align="center">
		<!-- MSTableType="layout" -->
		<tr>
		  <td height="38"><font face="Times new Roman" size="6"><b>
			<font color="#335577">About</font> <font color="#8C97A2">us</font></b></font></td>
		</tr>
		<tr>
		  <td height="18"><hr color="#8C97A2" size="1"></td>
		</tr>
		<tr>
		  <td height="568" valign="top" width="331"><div align="justify">
			<font face="Tahoma" size="2">London's Day-Out</font><font size="2" color="#4F4F4F" face="Tahoma"><br>
&nbsp; London's Day-Out is a small travel company that organises short tours for 
			tourist visiting London. Beside offering visits to all the famous 
			city's landmarks, the company also organises day trips to nearby 
			towns like Bath, Cambridge, Oxford, Leeds castle, Canterbury, 
			Stonehenge and Cotswold Villages, etc.<br>
&nbsp;&nbsp; Mr. </font><font size="2" face="Tahoma">Henri Randall</font><font size="2" color="#4F4F4F" face="Tahoma"> 
			:: Director of London's Day-out</font></div><hr color="#8C97A2" size="1">
			Our <font color="#666666">postal address<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IT Manager,<br>
			</font> 
			<font face="Tahoma" size="2" color="#4F4F4F">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font> 
			<font face="Tahoma" size="2">Mr. Chloe,</font><font face="Tahoma" size="2" color="#4F4F4F"> <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 24 Great Chapel 
			Street,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Central London,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; United Kingdom<br>
			</font><font face="Tahoma" size="2"> Telephone</font><font face="Tahoma" size="2" color="#4F4F4F"> 
			no.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>
				<font color="#4F4F4F" face="Tahoma" style="font-size: 9pt">020000000 </font><hr color="#8C97A2" size="1">
<div align="justify">
			<font face="Tahoma" size="2">About</font><font face="Tahoma" size="2" color="#4F4F4F"> 
			Website<br>
                &nbsp;&nbsp;&nbsp; This website is designed, developed, programmed 
                &amp; maintained by Santosh k. Gurung. For any kind of problems, 
                suggestions or comments please do contact me at <a href="mailto:seeksantos@gmail.com">seeksantos@gmail.com</a></font></div>
...
&nbsp;</td>
	...
	<tr>
		<td valign="top" colspan="8" rowspan="2">&nbsp;</td>
		<td></td>
		<td height="102"></td>
		</tr>
	<tr>
