...
if(($_SESSION["status"]=="loggedin") && ($_SESSION["username"]!=""))
{
	...
	$xs_sql="SELECT * FROM `memberinfo` WHERE `username`='" . $gid. "'";
...
<font color="#336699" size="4" face="Verdana, Arial, Helvetica, sans-serif">Access 
  Denied!</font>
<hr color="#003333">
<font color="#336699" size="2" face="Verdana, Arial, Helvetica, sans-serif">Please login to view your details.<br>If this problem occurs again please tell your administrator. </font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
</font> 
<?php
}
?>
