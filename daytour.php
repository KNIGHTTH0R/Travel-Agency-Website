...
-->
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="785" height="1487">
    <!-- MSTableType="layout" -->
    <tr>
...
background-repeat: repeat-x">&nbsp;</td>
	...
	<tr>
      <td valign="top" rowspan="12" bgcolor="#F3F3F3" style="border-bottom: 1px solid #C0C0C0">
	    <div align="center">
	      <Table width="330" height="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <!-- MSTableType="layout" -->
            <tr>
		  <td colspan="3" height="39"><b>
			<font color="#335577" face="Times new Roman" size="6">Trips </font></b>
			<font face="Tahoma" color="#8C97A2" style="font-size: 8pt">
			Day trips to different places of UK.</font></td>
			</tr>
			<tr>
		  <td colspan="3" height="18"><hr color="#8C97A2" size="1"></td>
			...
			<font color="#384B67" size="2" face="Arial">Stonehenge is one of the 
				...
				<a href="places.php?id=101"><font color="#5F9119">View details....</font></a></font></div></td>
				</tr>
			<tr>
...
and now I&#39;m happy I have seen most of the places. Thank You,</font></div>
	...
	<tr>
		...
		<td valign="top" colspan="10" background="images/fadegreyup.gif"  style="background-repeat: repeat-x">&nbsp;</td>
		<td height="226"></td>
		</tr>
	<tr>
		<td bgcolor="#494949" colspan="15" height="76">
