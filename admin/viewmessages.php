...
<table border="0" cellspacing="0" cellpadding="0" id="table2" style="border: 1px solid #808080" width="966" height="45">
			<!-- MSTableType="layout" -->
			<tr>
				
          <td valign="top" style="border-bottom: 1px solid #808080" bgcolor="#669900" colspan="5">
			&nbsp;Comments &amp; Messages</td>
				
        <td valign="top" colspan="3" height="20" bgcolor="#669900"> <div align="right"><span align= "left">Total 
            Messages= 
            <?php
...
?>
			...
			<tr>
				...
				Email</td>
				<td align="center" style="border-right: 1px solid #808080; border-bottom: 1px solid #808080">Address</td>
				<td valign="top" align="center" style="border-right:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; ">Message</td>
				<td height="23" valign="top" align="center" style="border-bottom: 1px solid #C0C0C0; ; border-left-width:1px; border-right-width:1px; border-top-width:1px">Function</td>
			</tr>
<?PHP
showmsgintable("contactusinfo",$conn);
