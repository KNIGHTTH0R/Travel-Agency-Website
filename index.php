...
<html>
 <head>
	...
	<title>London's Day out:: Trips to exciting places of London::UK</title>
...
-->
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="785" height="1045">
    <!-- MSTableType="layout" -->
    <tr>
	...
	<tr>
      <td colspan="12" bgcolor="#504F4F" style="border-left: 1px solid #504F4F; border-right: 1px solid #504F4F; border-top-width: 1px; border-bottom-width: 1px"> 
        <div id="navigation" style="width: 100%; height: 29px">
			<ul>
				<li id="pagein"><a href="index.php" title="Home">Home</a></li>
...
background-repeat: repeat-x">&nbsp;</td>
	...
	<tr>
      <td valign="top" rowspan="13" bgcolor="#F3F3F3" style="border-bottom: 1px solid #C0C0C0">
	    <div align="center">
	      <Table width="332" height="516" border="0" align="center" cellpadding="0" cellspacing="0" id="table2">
            <!-- MSTableType="layout" -->
            <tr>
		  <td colspan="3"><b>
		...
		<td height="62"></td>
			...
			<tr>
		  <td colspan="3"><hr color="#8C97A2" size="1"></td>
			<td height="15"></td>
			</tr>
			<tr>
				<td>
				<a href="daytour.php">
				<img border="0" src="images/daybanneralike.jpg" width="137" height="100"></a></td>
				<td rowspan="3" width="10">&nbsp;</td>
				<td>
				<p align="justify"><font color="#335577" face="Arial" size="2">
				A day trip::.<br>
				Now take your most available time &amp; get involved with us &amp; share 
				the beauty of London, any day that you are.<font color="#737373">
				</font> <a href="daytour.php">
				<font color="#5F9119">Read more.. </font></a> </font> </td>
				<td height="131"></td>
			</tr>
			<tr>
				<td bgcolor="#E7E7E7">
				
				<a href="weekendtour.php">
				
				<img border="0" src="images/weekendbanneralike.jpg" width="137" height="100"></a></a></td>
				<td bgcolor="#E7E7E7">
				<p align="justify">
				<font face="Arial" style="font-size: 10pt" color="#335577">
				A Weekend trip::.<br>
				Now take your weekend holiday with us to enjoy, just hurry up 
				register.<a href="weekendtour.php"> <font color="#5F9119">Read more.</font></a></font></td>
				<td height="121"></td>
			</tr>
			<tr>
				<td width="137">
				<a href="places.php?id=401">
				<img border="0" src="images/specialbanneralike.jpg" width="137" height="100"></a></td>
				<td width="183">
				<p align="justify"><font size="2" face="Arial" color="#335577">
				A Special trip<br>
				Now take your full control over where to go. Just hurry up now 
				register &amp; be a member and have a tip to the exciting places.
				<a href="places.php?id=401"><font color="#5F9119">Read more. </font>
				</a>
				</font>
				</td>
				<td height="108" width="2"></td>
			</tr>
			<tr>
			...
			<tr>
			<td valign="top" colspan="4" height="64">
	...
	<tr>
		...
		<a href="reference.php?tag=reference&paskey=<?php echo $passkey  ?>">Read 
		more....</a></font></td>
...
and now I&#39;m happy I have seen most of the places. Thank You,</font></div>
	...
	<tr>
		<td valign="top" colspan="3" rowspan="2" background="images/fadegreyup.gif"  style="background-repeat: repeat-x">&nbsp;</td>
		<td></td>
		<td height="2"></td>
	</tr>
	<tr>
	...
	<tr>
		<td bgcolor="#494949" colspan="15" height="74">
