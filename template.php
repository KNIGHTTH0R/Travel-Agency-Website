...
<html>
 <head>
	...
	<title>Terms &amp; Conditions:: London's Day out:: Day Trips to exciting places 
	of London::UK</title>
...
-->
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="784" height="1121">
    <!-- MSTableType="layout" -->
    <tr>
      ...
      <td colspan="12" bgcolor="#504F4F" style="border-left: 1px solid #504F4F; border-right: 1px solid #504F4F; border-top-width: 1px; border-bottom-width: 1px"> 
        <div id="navigation" style="width: 100%; height: 29px">
			<ul>
				...
				<li><a title="Places" href="places.php">Tours</a></li>
	...
	<tr>
      <td bgcolor="#D8D8D8" background="images/fadegrey.JPG" style="border: 1px solid #8C97A2" colspan="3"> 
        <p align="left"><font size="3" face="Times New Roman"> &nbsp;&nbsp;&nbsp;&nbsp;Logged-in::.</font></td>
...
&nbsp;</td>
	...
	<tr>
		...
		<td valign="top" colspan="10" height="85">&nbsp;</td>
		</tr>
	<tr>
